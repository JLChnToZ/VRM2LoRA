...
#pragma warning restore 0649
		...
		protected override void OnBound( MemberInfo variable )
		{
			...
			if( BoundVariableType == typeof( float ) || BoundVariableType == typeof( double ) || BoundVariableType == typeof( decimal ) )
				input.BackingField.contentType = TMPro.TMP_InputField.ContentType.DecimalNumber;
			else
				input.BackingField.contentType = TMPro.TMP_InputField.ContentType.IntegerNumber;
